...
2. The first player in any player array is the goalkeeper and the others are field players. For BayernMunic (team 1) create one variable ('gk') with goalkeeper's name, and one array ('fieldPlayers') with all th remaining 10 field players.
3. Create an array 'allPlayers' containing all players of both teams (22 players).
4. during the game, Bayern Munich (team 1) used 3 substitute players. So create a new array ('players1Final') containing all the original tem1 players plus 'Thiago', 'Coutinho' and 'Perisic'.
